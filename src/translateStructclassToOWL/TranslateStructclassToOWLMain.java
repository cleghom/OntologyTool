...
public class TranslateStructclassToOWLMain {
	...
	public static void main(String[] args) throws OntologyLoadException, IOException {
		String s = "植物是生物。人是智慧生物。人是劳动工具。智慧生物是生物。劳动工具是工具。人是动物，动物是生物。刘晓涛是一个中国人。德国是一个政权组织。Eclipse是一个代码工具，代码工具是工具。胡锦涛是中华人民共和国的主席,中国人是人。美国人是人。胡锦涛是一个中国人。奥巴马是一个美国人。德国是一个国家。奥巴马是一个美国人。中华人民共和国是一个国家。";
		String ss = "赵航是云南大学的学生。小刘的昵称是刘二，小刘是一个厨师，刘大伟的昵称是伟伟。刘大伟是一个厨师。小王的性别是男，小王的年龄是27.小王的父亲是老王，小王的母亲是张丽。张丽是一个教师。老王是一个工人。小王是一个厨师，小王是一个裁缝。植物是生物。人是智慧生物。人是劳动工具。智慧生物是生物。德国是一个政权组织,德国是国家。张强是我校的学生会主席。刘涛的电话号码是13866655333。赵航的电话号码是14787806414。赵航的学生证封面颜色是红的。赵航是一个中国人。";
		String sss = "鹅是鸟。癌症的致死率是高的。癌症的潜伏期是5年的。癌症是一个疾病。艾滋病的潜伏期是12年。艾滋病的感染性是强的。艾滋病的疾病传播方式是性传播。艾滋病是一个疾病。毛毛的羽毛颜色是黑色的。毛毛是一个麻雀。鸟的翅膀个数是2，大雁是鸟。牛牛的年龄是10.大雁的羽毛颜色是白色的。鹅的羽毛颜色是白色的。牛牛是一个大雁，麻雀的翅膀个数是2，麻雀是鸟。";
		String ssss = "Eclipse的性能是ok的。感冒的潜伏期是2天。感冒是一个疾病。";
		String sssss = "";
		// String base = "base";
		// mainfunction(ooo, s, base, "aaaaaaaa");
		String fileuri = "D:/owlmodel/aaaaaaaa.owl";
		mainfunction(s + ss + sss + ssss + sssss, fileuri, "base", "kkkkkkk");
	}
